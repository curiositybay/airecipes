  ...
  mock: {
    ...
    process: {
      ...
      env: {
        ...
        NEXT_PUBLIC_APP_DESCRIPTION: 'Test App Description',
        NEXT_PUBLIC_API_URL: 'http://localhost:3000',
        NEXT_PUBLIC_APP_SLUG: 'test-app',
        NEXT_PUBLIC_APP_DOMAIN: 'test-domain.com',
        NEXT_PUBLIC_APP_URL: 'https://test-domain.com',
        NEXT_PUBLIC_GITHUB_REPO: 'https://github.com/test/repo',
        NEXT_PUBLIC_APP_AUTHOR: 'Test Author',
        NEXT_PUBLIC_APP_KEYWORDS: 'test, app',
        NEXT_PUBLIC_TWITTER_HANDLE: '@test',
        NEXT_PUBLIC_CONTACT_EMAIL: 'test@example.com',
        NEXT_PUBLIC_404_MESSAGE: 'Test 404 message',
        NEXT_PUBLIC_500_MESSAGE: 'Test 500 message',
